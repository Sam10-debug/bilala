...
const HeroSection = () => {
  return (
	<section className="md:h-[760px] relative flex md:py-20 bg-red-400 items-center  flex-col">
		<h1 className="text-[40px] md:text-[90px] text-center font-[400] text-white">A NEW WAY TO <br /> <span className="  font-bold text-[48px] md:text-[100px]">INVEST IN CRYPTOMINING</span></h1>
		<p className=" text-[22px] leading-[33px] text-white w-4/5 py-[35px] text-center">It is super simple - Your mining equipment is already configured and running.
		...
		<section className=" md:absolute md:bottom-[-25%] text-white flex flex-col md:flex-row md:w-4/5 justify-between">
			<div className="p-4 md:h-[350px] first bg-red-900">
			...
			<div className="p-4 md:h-[350px] second bg-red-900 ">
